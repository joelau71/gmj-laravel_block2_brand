...
use GMJ\LaravelBlock2Brand\Http\Controllers\ConfigController;
use GMJ\LaravelBlock2Brand\Http\Controllers\BlockController;
use Illuminate\Support\Facades\Route;

Route::group([
    "middleware" => ["web", "auth"],
    "prefix" => "admin/element/{element_id}/gmj/laravel_block2_brand",
    "as" => "LaravelBlock2Brand."
], function () {
